...
function getCredential(formValues, callback, err) {
  if (err) console.log(err);
    ...
    var poolData = {
      UserPoolId: "us-west-2_QSVYmFY24", // Your user pool id here
      ClientId: "2utldionhnvsu1idbp43srdri7", // Your client id here
    };
    ...
    cognitoUser.authenticateUser(authenticationDetails, {
      onSuccess: function(result) {
        ...
        AWS.config.credentials = new AWS.CognitoIdentityCredentials({
          IdentityPoolId: "us-west-2:7f4b9075-7717-4147-9855-3bf13cc2a236", // your identity pool id here
          Logins: {
            // Change the key below according to the specific region your user pool is in.
            "cognito-idp.us-west-2.amazonaws.com/us-west-2_QSVYmFY24": result
              .getIdToken()
              .getJwtToken(),
          },
        });
